...
# Generation Time: 2017-03-31 01:10:20 +0000
# ************************************************************
...
VALUES
	(1,'Member','2017-03-31 00:58:43','2017-03-30 21:58:57','Default Admin',NULL,'admin','d2d2cffc04bcab4eb7363bc7c4fb930828050ab2','2017-04-03 00:58:43','$2y$10$380cba20c33ed1776e539ur.fqKDhi4ugHE0f8hm52/XF7aY1bjWK',NULL,3,'2017-03-31 01:09:13',NULL,NULL,'blowfish','10$380cba20c33ed1776e5398',NULL,NULL,'en_US',0,'yyyy-MM-dd','H:mm');
...
CREATE TABLE `SiteTree` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ClassName` enum('SiteTree','Page','ErrorPage','RedirectorPage','VirtualPage','BroadbandCheckerPage','DataSpeedCalculatorPage','HomePage') DEFAULT 'SiteTree',
  `LastEdited` datetime DEFAULT NULL,
  `Created` datetime DEFAULT NULL,
...
VALUES
	...
	(6,'Page','2017-03-31 01:03:28','2017-03-31 01:02:51','how-to-guides','How To Guides',NULL,NULL,NULL,NULL,1,1,6,0,0,NULL,'Inherit','Inherit',2,0),
	(7,'Page','2017-03-31 01:04:07','2017-03-31 01:03:45','broadband-providers','Broadband Providers',NULL,NULL,NULL,NULL,1,1,7,0,0,NULL,'Inherit','Inherit',2,0);
